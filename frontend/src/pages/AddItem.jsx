      ...
      <div className="card shadow p-4" style={{ maxWidth: '600px' }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <input type="url" name="image_url" className="form-control" onChange={handleChange} placeholder="https://..." />
          </div>
          <button type="submit" className="btn btn-success">Add Item</button>
          <button type="button" onClick={() => navigate('/home')} className="btn btn-secondary ms-3">
            Cancel
          </button>
        </form>
      </div>
